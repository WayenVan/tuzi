...
pub fn bindings() -> Vec<Binding> {
	...
	vec![
		...
		Binding::manager(vec![Key::char('z'), Key::char('c')], A::CollapseSubtree, "Collapse current subtree"),
		Binding::manager(vec![Key::char('z'), Key::char('m')], A::CollapseAll, "Collapse all subtrees"),
		Binding::manager(vec![Key::char('z'), Key::char('z')], A::CenterCursor, "Center current row"),
		...
		Binding::manager(vec![Key::char(' '), Key::char('-')], A::PasteLink { absolute: false }, "Paste as a relative symlink"),
		Binding::manager(vec![Key::char(' '), Key::char('_')], A::PasteLink { absolute: true }, "Paste as an absolute symlink"),
		Binding::manager(vec![Key::char(' '), Key::char(' ')], A::Fzf, "Jump with fzf"),
